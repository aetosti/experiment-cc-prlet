...
class CalibrationInstructions(BaseState):
    def __init__(self):
        super(CalibrationInstructions, self).__init__()

        self.next_state = "CALIBRATION_TASK"

        self.text = "This are the Instructions to Follow for the Calibration Task. The text should go automatically in a new line when needed."
